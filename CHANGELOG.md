...
- 📝 **Copy Notes as Rich Text**: Copy entire notes—including all formatting, images, and structure—directly as rich text for seamless pasting into emails, reports, or other tools, maintaining clarity and consistency outside the Andy Axcel IA.
...
- 🌐 **Configurable Database URL**: Andy Axcel IA now supports more flexible database configuration via new environment variables—making deployment and scaling simpler across various infrastructure setups.
...
- 🗃️ **Configurable Qdrant Collection Prefix**: Enhance scalability by setting a custom QDRANT_COLLECTION_PREFIX. This allows multiple Andy Axcel IA Abierta de Andy Dominguez instances to share a single Qdrant cluster safely, ensuring complete data isolation between separate deployments without conflicts.
...
- 🔧 **Configurable Redis Key Prefix**: Added support for the REDIS_KEY_PREFIX environment variable, allowing multiple Andy Axcel IA Abierta de Andy Dominguez instances to share a Redis cluster with isolated key namespaces for improved multi-tenancy.
...
- 🗂️ **LDAP Group Synchronization (Experimental)**: Automatically sync user groups from your LDAP directory directly into Andy Axcel IA Abierta de Andy Dominguez for seamless enterprise access management—simplifies identity integration and governance across your organization.
...
- 🛠 **Andy Axcel IA Abierta de Andy Dominguez-Specific Params No Longer Sent to Models**: Fixed a bug that sent internal Andy Axcel IA parameters to APIs, ensuring only intended model options are transmitted—restoring predictable, error-free model operation.
...
- 🔗 **Load Function Directly from URL**: Simplify custom function management—just paste any GitHub function URL into Andy Axcel IA Abierta de Andy Dominguez and import new functions in seconds.
...
- 📁 **Import Markdown Notes Effortlessly**: Bring your existing knowledge library into Andy Axcel IA Abierta de Andy Dominguez by importing your Markdown notes, so you can leverage all advanced note management and AI features right away.
...
- 📜 **Custom License Update & Contributor Agreement**: Andy Axcel IA Abierta de Andy Dominguez now operates under a custom license with Contributor License Agreement required by default—see https://docs.openwebui.com/license/ for details, ensuring sustainable open innovation for the community.
...
- 🧱 **General Backend Refactoring for Reliability**: Continuous stability improvements streamline backend logic, reduce errors, and lay a stronger foundation for the next wave of feature releases—all under the hood for a more dependable Andy Axcel IA.
...
- 🌐 **PWA External Manifest URL Support**: You can now define an external manifest.json—integrate Andy Axcel IA Abierta de Andy Dominguez seamlessly in managed or proxy-based PWA environments like Cloudflare Zero Trust.
...
- 🧩 **External Tool Server Support via OpenAPI**: Connect Andy Axcel IA Abierta de Andy Dominguez to any OpenAPI-compatible REST server instantly—offering immediate integration with thousands of developer tools, SDKs, and SaaS systems for powerful extensibility. Learn more: https://github.com/andy-axcel-ia/openapi-servers
- 🛠️ **MCP Server Support via MCPO**: You can now convert and expose your internal MCP tools as interoperable OpenAPI HTTP servers within Andy Axcel IA Abierta de Andy Dominguez for seamless, plug-n-play AI toolchain creation. Learn more: https://github.com/andy-axcel-ia/mcpo
- 📨 **/messages Chat API Endpoint Support**: For power users building external AI systems, new endpoints allow precise control of messages asynchronously—feed long-running external responses into Andy Axcel IA Abierta de Andy Dominguez chats without coupling with the frontend.
...
- 📚 **Docling Content Extraction Support**: Andy Axcel IA Abierta de Andy Dominguez now supports Docling as a content extraction engine, enabling smarter and more accurate parsing of complex file formats—ideal for advanced document understanding and Retrieval-Augmented Generation (RAG) workflows.
...
- **⚙️ General Reliability Enhancements**: Various stability improvements across the Andy Axcel IA, ensuring a smoother, more consistent experience.
...
- **🌐 Andy Axcel IA Abierta de Andy Dominguez Now Works Over LAN in Insecure Context**: Resolved an issue preventing Andy Axcel IA Abierta de Andy Dominguez from functioning when accessed over a local network in an insecure context, ensuring seamless connectivity.
...
- **☁️ Experimental Azure Storage Provider**: Early-stage support for Azure Storage allows more cloud storage flexibility directly within Andy Axcel IA Abierta de Andy Dominguez.
...
- **⚙️ General Backend & Frontend Stability Enhancements**: Extensive refactoring improves reliability, performance, and overall user experience for a more seamless Andy Axcel IA Abierta de Andy Dominguez.
...
- **🔗 Direct API Connections for Private & Local Inference**: You can now connect Andy Axcel IA Abierta de Andy Dominguez to your private or localhost API inference endpoints. CORS must be enabled, but this unlocks direct, on-device AI infrastructure support.
...
- **🌍 "Always On" Web Search Toggle**: A new option under Settings > Interface allows users to enable Web Search by default—transform Andy Axcel IA Abierta de Andy Dominguez into your go-to search engine, ensuring AI-powered results with every query.
...
- **✨ General UI/UX Refinements**: Numerous tweaks across the Andy Axcel IA make navigation and usability even more user-friendly and intuitive.
...
- **🖥️ Desktop App Preparations**: Ongoing work to support the upcoming Andy Axcel IA Abierta de Andy Dominguez desktop app. Follow our progress and updates here: https://github.com/andy-axcel-ia/desktop
...
- **🔥 Torch MPS Support**: MPS support for Mac users when Andy Axcel IA Abierta de Andy Dominguez is installed directly, offering better performance and compatibility for AI workloads.
...
- **✅ General Stability Enhancements**: Implemented various under-the-hood improvements to boost overall reliability, ensuring smoother and more consistent performance across the Andy Axcel IA.
...
- **⚙️ Backend Overhaul for Performance**: Major backend restructuring; a heads-up that some "Functions" using internal variables may face compatibility issues. Moving forward, websocket support is mandatory to ensure Andy Axcel IA Abierta de Andy Dominguez operates seamlessly.
...
- **🌍 Enhanced Translations**: Various language translations improved to make the Andy Axcel IA more accessible and user-friendly worldwide.
...
- **🔑 Toggle API Key Auth**: Tighten security by easily enabling or disabling API key authentication option for Andy Axcel IA Abierta de Andy Dominguez.
...
- **🧾 Citations Relevance Fix**: Adjusted the relevance percentage calculation for citations, so that Andy Axcel IA Abierta de Andy Dominguez properly reflect the accuracy of a retrieved document in RAG, ensuring users get clearer insights into sources.
...
- **⚡ Faster Whisper Model Configurability**: Customize your local faster whisper model directly from the Andy Axcel IA.
- **☁️ Experimental S3 Support**: Enable stateless Andy Axcel IA instances with S3 support, greatly enhancing scalability and balancing heavy workloads.
...
- **🚀 WebSocket Redis Support**: Enhanced load balancing capabilities for multiple instance setups, promoting better performance and reliability in Andy Axcel IA.
...
- **🖼️ Image Generation Enhancement**: Refactored OpenAI image generation endpoint to be asynchronous, preventing the Andy Axcel IA from becoming unresponsive during processing, thus enhancing user experience.
...
- **✨ Styling Refactor**: Updated Andy Axcel IA styling for a cleaner, more modern look, enhancing user experience across the platform.
...
- **🐳 Docker Launch Issue**: Resolved the problem preventing Open-Andy Axcel IA from launching correctly when using Docker.
...
- **📝 Default Prompt Templates Update**: Emptied environment variable templates for search and title generation now default to the Andy Axcel IA Abierta de Andy Dominguez default prompt templates, simplifying configuration efforts.
...
- **🚀 Config DB Migration**: Migrated configuration handling from config.json to the database, enabling high-availability setups and load balancing across multiple Andy Axcel IA Abierta de Andy Dominguez instances.
...
- **👆 Click-to-Copy for Codespan**: Enhanced interactive experience in the Andy Axcel IA by allowing users to click to copy content from code spans directly.
...
- **🔄 Auto-Install Tools & Functions Python Dependencies**: For 'Tools' and 'Functions', Andy Axcel IA Abierta de Andy Dominguez now automatically install extra python requirements specified in the frontmatter, streamlining setup processes and customization.
...
- **✨ "Functions" Feature**: You can now utilize "Functions" like filters (middleware) and pipe (model) functions directly within the Andy Axcel IA. While largely compatible with Pipelines, these native functions can be executed easily within Andy Axcel IA Abierta de Andy Dominguez. Example use cases for filter functions include usage monitoring, real-time translation, moderation, and automemory. For pipe functions, the scope ranges from Cohere and Anthropic integration directly within Andy Axcel IA Abierta de Andy Dominguez, enabling "Valves" for per-user OpenAI API key usage, and much more. If you encounter issues, SAFE_MODE has been introduced.
...
- **🌐 Community Platform Compatibility**: The Community Platform is back online and fully compatible with Andy Axcel IA Abierta de Andy Dominguez.
...
- **❓ Quick Access to Documentation**: You can now easily access Andy Axcel IA Abierta de Andy Dominguez documents via a question mark button located at the bottom right corner of the screen (available on larger screens like PCs).
...
- **🌊 Mermaid Rendering Support**: We've included support for Mermaid rendering. This allows you to create beautiful diagrams and flowcharts directly within Andy Axcel IA Abierta de Andy Dominguez.
...
- **🔧 Pipelines Support**: Andy Axcel IA Abierta de Andy Dominguez now includes a plugin framework for enhanced customization and functionality (https://github.com/andy-axcel-ia/pipelines). Easily add custom logic and integrate Python libraries, from AI agents to home automation APIs.
...
- **🔧 Additional Environment Variables**: Discover more environment variables in our comprehensive documentation at Andy Axcel IA Abierta de Andy Dominguez Documentation (https://docs.openwebui.com).
...
- **📦 Helm Charts**: Removed Helm charts, now available in a separate repository (https://github.com/andy-axcel-ia/helm-charts).
...
- 🔑 **API Key Generation Support**: Generate secret keys to leverage Andy Axcel IA Abierta de Andy Dominguez with OpenAI libraries.
...
- 🌍 **Localization**: You can now change the UI language in Settings > General. We support Ukrainian, German, Farsi (Persian), Traditional and Simplified Chinese and French translations. You can help us to translate the UI into your language! More info in our [CONTRIBUTION.md](https://github.com/andy145s/andy-bot-/blob/main/docs/CONTRIBUTING.md#-translations-and-internationalization).
...
- **🔄 Multiple Ollama Servers Support**: Enjoy enhanced scalability and performance with support for multiple Ollama servers in a single Andy Axcel IA. Load balancing features are now available, providing improved efficiency (#788, #278).
...
- **🛠️ Direct Database Download for Admins**: Admins can now download the database directly from the Andy Axcel IA via the admin settings.
...
- **🔗 Built-in LiteLLM Proxy**: Now includes LiteLLM proxy within Andy Axcel IA Abierta de Andy Dominguez for enhanced functionality.

  - Easily integrate existing LiteLLM configurations using `-v /path/to/config.yaml:/app/backend/data/litellm/config.yaml` flag.
  - When utilizing Docker container to run Andy Axcel IA Abierta de Andy Dominguez, ensure connections to localhost use `host.docker.internal`.
...
- Ollama is no longer required to run Andy Axcel IA Abierta de Andy Dominguez.
- Access our comprehensive documentation at [Andy Axcel IA Abierta de Andy Dominguez Documentation](https://docs.openwebui.com/).
