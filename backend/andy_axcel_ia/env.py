...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "Andy Axcel IA Abierta de Andy Dominguez")
if WEBUI_NAME != "Andy Axcel IA Abierta de Andy Dominguez":
    WEBUI_NAME += " (Andy Axcel IA Abierta de Andy Dominguez)"
...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("andy-axcel-ia")}
else:
    try:
...
try:
    ...
    changelog_content = (pkgutil.get_data("andy_axcel_ia", "CHANGELOG.md") or b"").decode()
...
if FROM_INIT_PY:
    ...
    if DATA_DIR.exists() and DATA_DIR != NEW_DATA_DIR:
        ...
        shutil.make_archive(DATA_DIR.parent / "andy_axcel_ia_data", "zip", DATA_DIR)
...
if os.path.exists(f"{DATA_DIR}/ollama.db"):
    ...
    log.info("Database migrated from Ollama-Andy Axcel IA successfully.")
else:
    pass
...
REDIS_KEY_PREFIX = os.environ.get("REDIS_KEY_PREFIX", "andy-axcel-ia")
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "andy-axcel-ia")
