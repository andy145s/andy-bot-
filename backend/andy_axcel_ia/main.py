...
from andy_axcel_ia.utils import logger
from andy_axcel_ia.utils.audit import AuditLevel, AuditLoggingMiddleware
from andy_axcel_ia.utils.logger import start_logger
from andy_axcel_ia.socket.main import (
    app as socket_app,
    periodic_usage_pool_cleanup,
    get_models_in_use,
    get_active_user_ids,
)
from andy_axcel_ia.routers import (
    audio,
    images,
    ollama,
    openai,
...
from andy_axcel_ia.routers.retrieval import (
...
from andy_axcel_ia.internal.db import Session, engine

from andy_axcel_ia.models.functions import Functions
from andy_axcel_ia.models.models import Models
from andy_axcel_ia.models.users import UserModel, Users
from andy_axcel_ia.models.chats import Chats
...
from andy_axcel_ia.utils.models import (
    get_all_models,
    get_all_base_models,
    check_model_access,
)
from andy_axcel_ia.utils.chat import (
    generate_chat_completion as chat_completion_handler,
    chat_completed as chat_completed_handler,
    chat_action as chat_action_handler,
)
from andy_axcel_ia.utils.embeddings import generate_embeddings
from andy_axcel_ia.utils.middleware import process_chat_payload, process_chat_response
from andy_axcel_ia.utils.access_control import has_access

from andy_axcel_ia.utils.auth import (
    get_license_data,
...
from andy_axcel_ia.utils.plugin import install_tool_and_function_dependencies
from andy_axcel_ia.utils.oauth import OAuthManager
from andy_axcel_ia.utils.security_headers import SecurityHeadersMiddleware
from andy_axcel_ia.utils.redis import get_redis_connection

from andy_axcel_ia.tasks import (
...
from andy_axcel_ia.utils.redis import get_sentinels_from_env
...
https://github.com/andy145s/andy-bot-
"""
)
...
app = FastAPI(
    title="Andy Axcel IA Abierta de Andy Dominguez",
...
if ENABLE_OTEL:
    from andy_axcel_ia.utils.telemetry.setup import setup as setup_opentelemetry
    ...
    try:
        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                "https://api.github.com/repos/andy-axcel-ia/andy-axcel-ia/releases/latest",
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for Andy Axcel IA Abierta de Andy Dominguez.
...
async def get_manifest_json():
    if app.state.EXTERNAL_PWA_MANIFEST_URL:
        ...
        return {
            ...
            "description": "Andy Axcel IA Abierta de Andy Dominguez is an open, extensible, user-friendly interface for AI that adapts to your workflow.",
            "start_url": "/",
            "display": "standalone",
