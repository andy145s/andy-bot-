from andy_axcel_ia.utils.task import prompt_template, prompt_variables_template
...
def remove_andy_axcel_ia_params(params: dict) -> dict:
    """
    Removes OpenAndy Axcel IA specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with OpenAndy Axcel IA parameters removed.
    """
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_andy_axcel_ia_params(params)
