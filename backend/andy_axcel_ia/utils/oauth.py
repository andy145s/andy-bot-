...
from andy_axcel_ia.models.auths import Auths
from andy_axcel_ia.models.users import Users
from andy_axcel_ia.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from andy_axcel_ia.constants import ERROR_MESSAGES, WEBHOOK_MESSAGES
...
from andy_axcel_ia.utils.misc import parse_duration
from andy_axcel_ia.utils.auth import get_password_hash, create_token
from andy_axcel_ia.utils.webhook import post_webhook

from andy_axcel_ia.env import SRC_LOG_LEVELS, GLOBAL_LOG_LEVEL
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions):
        ...
        log.debug(
            f"All groups available in OpenAndy Axcel IA: {[g.name for g in all_available_groups]}"
        )
