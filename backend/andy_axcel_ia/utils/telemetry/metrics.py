"""OpenTelemetry metrics bootstrap for Andy Axcel IA Abierta de Andy Dominguez.
...
`/metrics` endpoint – Andy Axcel IA does **not** expose it directly.
...
from andy_axcel_ia.env import OTEL_SERVICE_NAME, OTEL_EXPORTER_OTLP_ENDPOINT

from andy_axcel_ia.socket.main import get_active_user_ids
