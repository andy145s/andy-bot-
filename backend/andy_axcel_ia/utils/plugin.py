...
from andy_axcel_ia.env import SRC_LOG_LEVELS, PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS
from andy_axcel_ia.models.functions import Functions
from andy_axcel_ia.models.tools import Tools
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from andy_axcel_ia.utils",
        "from apps": "from andy_axcel_ia.apps",
        "from main": "from andy_axcel_ia.main",
        "from config": "from andy_axcel_ia.config",
    }
