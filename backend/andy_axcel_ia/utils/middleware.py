...
from andy_axcel_ia.models.folders import Folders
from andy_axcel_ia.models.users import Users
from andy_axcel_ia.socket.main import (
    get_event_call,
    get_event_emitter,
    get_active_status_by_user_id,
)
from andy_axcel_ia.routers.tasks import (
    generate_queries,
    generate_title,
    generate_follow_ups,
...
from andy_axcel_ia.routers.retrieval import process_web_search, SearchForm
from andy_axcel_ia.routers.images import (
    load_b64_image_data,
    image_generations,
    GenerateImageForm,
    upload_image,
)
from andy_axcel_ia.routers.pipelines import (
    process_pipeline_inlet_filter,
    process_pipeline_outlet_filter,
)
from andy_axcel_ia.routers.memories import query_memory, QueryMemoryForm

from andy_axcel_ia.utils.webhook import post_webhook


from andy_axcel_ia.models.users import UserModel
from andy_axcel_ia.models.functions import Functions
from andy_axcel_ia.models.models import Models

from andy_axcel_ia.retrieval.utils import get_sources_from_items


from andy_axcel_ia.utils.chat import generate_chat_completion
from andy_axcel_ia.utils.task import (
    get_task_model_id,
    rag_template,
...
from andy_axcel_ia.utils.tools import get_tools
from andy_axcel_ia.utils.plugin import load_function_module_by_id
from andy_axcel_ia.utils.filter import (
    get_sorted_filter_ids,
    process_filter_functions,
)
from andy_axcel_ia.utils.code_interpreter import execute_code_jupyter

from andy_axcel_ia.tasks import create_task
...
from andy_axcel_ia.constants import TASKS
...
def apply_params_to_form_data(form_data, model):
    ...
    for key in list(params.keys()):
        if key in andy_axcel_ia_params:
            del params[key]
