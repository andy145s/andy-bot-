...
from andy_axcel_ia.models.users import Users, UserNameResponse
from andy_axcel_ia.models.channels import Channels
from andy_axcel_ia.models.chats import Chats
from andy_axcel_ia.models.notes import Notes, NoteUpdateForm
from andy_axcel_ia.utils.redis import (
...
from andy_axcel_ia.utils.auth import decode_token
from andy_axcel_ia.socket.utils import RedisDict, RedisLock, YdocManager
from andy_axcel_ia.tasks import create_task, stop_item_tasks
from andy_axcel_ia.utils.redis import get_redis_connection
from andy_axcel_ia.utils.access_control import has_access, get_users_with_access
...
if WEBSOCKET_MANAGER == "redis":
    ...
    SESSION_POOL = RedisDict(
        "andy-axcel-ia:session_pool",
        redis_url=WEBSOCKET_REDIS_URL,
        redis_sentinels=redis_sentinels,
    )
    USER_POOL = RedisDict(
        "andy-axcel-ia:user_pool",
        redis_url=WEBSOCKET_REDIS_URL,
        redis_sentinels=redis_sentinels,
    )
    USAGE_POOL = RedisDict(
        "andy-axcel-ia:usage_pool",
        redis_url=WEBSOCKET_REDIS_URL,
        redis_sentinels=redis_sentinels,
    )
...
YDOC_MANAGER = YdocManager(
    redis=REDIS,
    redis_key_prefix="andy-axcel-ia:ydoc:documents",
)
