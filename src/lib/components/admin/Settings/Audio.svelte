			...
			<div>
				...
				{:else if STT_ENGINE === ''}
					<div>
						...
						<div class="mt-2 mb-1 text-xs text-gray-400 dark:text-gray-500">
							{$i18n.t(`Andy Axcel IA Abierta de Andy Dominguez uses faster-whisper internally.`)}
				...
				<div class="mb-2">
					...
					{:else if TTS_ENGINE === 'transformers'}
						<div>
							...
							<div class="mt-2 mb-1 text-xs text-gray-400 dark:text-gray-500">
								{$i18n.t(`Andy Axcel IA Abierta de Andy Dominguez uses SpeechT5 and CMU Arctic speaker embeddings.`)}
