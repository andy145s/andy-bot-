...
<div class="flex flex-col h-full justify-between text-sm" id="tab-general">
	<div class="  overflow-y-scroll max-h-[28rem] lg:max-h-full">
		<div class="">
			<div class=" mb-1 text-sm font-medium">{$i18n.t('Andy Axcel IA Settings')}</div>
			...
			{#if $i18n.language === 'en-US'}
				<div class="mb-2 text-xs text-gray-400 dark:text-gray-500">
					...
					<a
						...
						href="https://github.com/andy-axcel-ia/andy-axcel-ia/blob/main/docs/CONTRIBUTING.md#-translations-and-internationalization"
						target="_blank"
					>
						Help us translate Andy Axcel IA Abierta de Andy Dominguez!
					</a>
				</div>
			{/if}
