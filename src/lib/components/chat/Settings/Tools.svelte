				...
				<div class="pr-1.5">
					...
					<div class="my-1.5">
						...
						>
							...
							<br />
							{$i18n.t(
								'CORS must be properly configured by the provider to allow requests from Andy Axcel IA Abierta de Andy Dominguez.'
							)}
						</div>
					</div>
					...
					<div class=" text-xs text-gray-600 dark:text-gray-300 mb-2">
						<a
							class="underline"
							href="https://github.com/andy-axcel-ia/openapi-servers"
